var hashModel = require('hash');

var ConsistentHash = function(nodes, opts) {
    this.opts = opts || {};
    this.replicas  = this.opts.replicas || 100;
    this.algorithm = this.opts.algorithm || 'MD5'; //http://fibjs.org/de/de9/namespacehash.html
...
var hash = function(algorithm, str) {
    ...
    return hashModel.digest(hashModel[algorithm],str).digest().hex();
};
